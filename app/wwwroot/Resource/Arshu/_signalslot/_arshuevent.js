; (function () {
    ...
    function unregisterCallback(name, callback) {
        ...
        if (eventsList[name] && eventsList[name] instanceof Array) {
            ...
            callback_index = eventsList[name].indexOf(callback);
