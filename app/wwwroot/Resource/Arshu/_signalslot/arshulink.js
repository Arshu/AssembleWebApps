(function (context) {
    ...
    ArshuLink.mixin = function (object, arshulink) {
        arshulink = arshulink || context.arshulink;
        object.fire = function (event, args) {
            arshulink.fire(this, event, args || {});
        }
        object.filter = function (filter, args) {
            return arshulink.filter(filter, args || {});
        }
    }

    context.ArshuLink = ArshuLink;
    context.arshulink = new ArshuLink();
